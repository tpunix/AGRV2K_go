...
#define usb_malloc(size) xos_malloc(size)
#define usb_free(ptr)    xos_free(ptr)
...
#define CONFIG_USB_EHCI_HCCR_BASE       (0x41001100)
#define CONFIG_USB_EHCI_HCOR_BASE       (0x41001140)

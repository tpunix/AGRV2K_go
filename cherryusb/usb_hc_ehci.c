...
static void ehci_qtd_bpl_fill(struct ehci_qtd_hw *qtd, uint32_t bufaddr, int buflen)
{
    uint32_t rest;
...
static void ehci_qtd_fill(struct ehci_qtd_hw *qtd, uint32_t bufaddr, int buflen, uint32_t token)
{
    /* qTD token
     *
     * FIELD    DESCRIPTION
